export const styles={
    ...
    mrginX:'sm:mx-16 mx-6',
    mrginY:'sm:my-16 my-6',
...
export const layout={
    ...
    sectionRevorse:`flex md:flex-row flex-col-reverse ${styles.paddingY}`,
    sectionInfo:`flex-1 ${styles.flexStart} flex-col`,
    sectionImage:`flex-1 flex ${styles.flexCenter} md:ml-10 ml-0 relative`,
    sectionImageRevorse:`flex-1 flex ${styles.flexCenter} md:mr-10 mr-0 md:mt-0 mt-10 relative`,
}